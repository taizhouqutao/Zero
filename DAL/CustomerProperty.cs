...
namespace WebApi.DAL
{
	...
	public partial class CustomerProperty
	{
		...
		public int GetMaxId()
		{
		return DbHelperMySQL.GetMaxID("SysNo", "T_CustomerProperty"); 
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select SysNo,CustomerSysNo,PropertySysNo,PropertyValue,Status,CreateTime,EditTime ");
			strSql.Append(" FROM T_CustomerProperty ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from T_CustomerProperty T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "T_CustomerProperty";
